...
| Family _(Version 2)_          | Premium × up to 5 seats at a discount                | Shared billing, per-member progress, parental controls — blocked on the parental-consent flow required by ADR-013 |
| Business _(Enterprise phase)_ | Per-seat, annual, sold to Enterprise LMS buyers      | Admin dashboards, reporting, SSO — depends on MULTITENANCY.md RLS work being in place                             |
