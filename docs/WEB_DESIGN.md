...
- **Phase 2c (follow-up, same `main`-backed APIs, not built yet):** assessment, speaking/pronunciation/listening/reading/writing practice, exam prep, certificates — all backed by real `main` APIs already, "just" need web UI + wiring, same shape of work as Phase 2a/2b.
