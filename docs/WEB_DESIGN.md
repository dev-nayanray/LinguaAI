...
- **Phase 2b (follow-up, same `main`-backed APIs, not built yet):** vocabulary/SRS, assessment, speaking/pronunciation/listening/reading/writing practice, exam prep, certificates — all backed by real `main` APIs already, "just" need web UI + wiring, same shape of work as Phase 2a.
