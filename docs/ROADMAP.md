...
| E6  | [AI Language Assessment Engine](epics/E6-ai-language-assessment-engine.md)               | L          | E4, E5 — **implementation in progress (T1–T2 done, 2026-08-07): AssessmentItem item bank (ADR-037); apps/api AssessmentModule attempt lifecycle, adaptive item selection, objective scoring (ADR-038), by explicit user direction rather than an independent Architecture Gate review; §12's gate sign-off log remains unchecked, not yet formally closed**                    |
