...
| E5  | [AI Gateway & Agent Orchestration Core](epics/E5-ai-gateway-agent-orchestration-core.md) | XL         | E1, E4 — **implementation in progress (T1–T7 done, 2026-08-07), by explicit user direction rather than an independent Architecture Gate review; §12's gate sign-off log remains unchecked, not yet formally closed**                                                                                                                                                                                                                                                                                                                  |
| E6  | [AI Language Assessment Engine](epics/E6-ai-language-assessment-engine.md)               | L          | E4, E5 — **implementation in progress (T1–T4 done, 2026-08-07): AssessmentItem item bank (ADR-037); apps/api AssessmentModule attempt lifecycle, adaptive item selection, objective scoring (ADR-038); CEFR banding/confidence + ProficiencyLevel/History writes; ai-engine AssessmentScoringService for Writing-skill AI scoring (ADR-039, service only, no REST endpoint yet), by explicit user direction rather than an independent Architecture Gate review; §12's gate sign-off log remains unchecked, not yet formally closed** |
