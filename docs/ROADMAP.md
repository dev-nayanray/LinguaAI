...
| E5  | [AI Gateway & Agent Orchestration Core](epics/E5-ai-gateway-agent-orchestration-core.md) | XL         | E1, E4 — **implementation in progress (T1–T11 done, 2026-08-07), by explicit user direction rather than an independent Architecture Gate review; §12's gate sign-off log remains unchecked, not yet formally closed**                                                                                                                                                          |
