 ...
 * and `GamificationModule` (E14 T1, ADR-054) — `ExerciseAttemptsService`'s
 * own synchronous, in-process consumer of
 * `GamificationService.recordActivity()`.
 */
@Module({
  imports: [AuthModule, AiEngineClientModule, GamificationModule],
  controllers: [
