 ...
 * not exported outside it. Duplicated from apps/web's own copy rather than
 * shared: identical today, but web/admin's form density is exactly the
 * kind of thing that legitimately diverges later (DESIGN_SYSTEM.md draws no
 * single spec for both), so premature sharing here would guess at that.
 */
