 ...
 * only thing in apps/web that actually imports through the alias, so it's
 * what proves this app's Vitest resolver entry isn't dead configuration.
 */
describe('@ui/* alias (apps/web Vitest resolver)', () => {
